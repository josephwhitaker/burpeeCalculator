...
//Rare exceptions to indicate a bug in the _burpeecalculator code (Eg, function that a subclass should have implemented)
...
/**
 The base class for BurpeeCalculator proxies.
 */
