...
// in simulator we redefine to format for BurpeeCalculator Developer console
...
{\
	NSString * exceptionName = [@"org.burpeecalculator." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.burpeecalculator";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBurpeeCalculatorNativeItemNone = -1, 
	UIBurpeeCalculatorNativeItemSpinner = -2,
	UIBurpeeCalculatorNativeItemProgressBar = -3,
	
	UIBurpeeCalculatorNativeItemSlider = -4,
	UIBurpeeCalculatorNativeItemSwitch = -5,
	UIBurpeeCalculatorNativeItemMultiButton = -6,
	UIBurpeeCalculatorNativeItemSegmented = -7,
	
	UIBurpeeCalculatorNativeItemTextView = -8,
	UIBurpeeCalculatorNativeItemTextField = -9,
	UIBurpeeCalculatorNativeItemSearchBar = -10,
	
	UIBurpeeCalculatorNativeItemPicker = -11,
	UIBurpeeCalculatorNativeItemDatePicker = -12,
	
	UIBurpeeCalculatorNativeItemInfoLight = -13,
	UIBurpeeCalculatorNativeItemInfoDark = -14,
	
	UIBurpeeCalculatorNativeItemDisclosure = -15,
	
	UIBurpeeCalculatorNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all BurpeeCalculator instances of
