...
@interface BurpeeCalculatorObject : KrollCoverageObject {
#else
@interface BurpeeCalculatorObject : KrollObject {
#endif
@private
...
extern NSString * BurpeeCalculator$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	BurpeeCalculatorObject *_burpeecalculator;
    KrollObject* console;
	BOOL shutdown;
