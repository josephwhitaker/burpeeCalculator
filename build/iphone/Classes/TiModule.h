...
/**
 The base class for all BurpeeCalculator modules
 */
...
/**
 BurpeeCalculator Platform calls this method on startup.
 */
-(void)startup;

/**
 BurpeeCalculator Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 BurpeeCalculator Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 BurpeeCalculator Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 BurpeeCalculator Platform calls this method on resume.
 @param sender The sender of the event.
 */
