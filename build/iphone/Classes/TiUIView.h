...
/**
 Base class for all BurpeeCalculator views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the BurpeeCalculator view hierarchy (such as wrapped iOS UIViews) was touched.
