...
//@interface BurpeeCalculatorObject : NSObject
//@end

@interface BurpeeCalculatorObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BurpeeCalculatorObject class]])
		{
			for (NSString *key in [[(BurpeeCalculatorObject*)o modules] allKeys])
			{
